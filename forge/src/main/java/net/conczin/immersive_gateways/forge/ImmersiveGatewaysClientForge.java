...
@Mod.EventBusSubscriber(modid = ImmersiveGateways.MOD_ID, value = Dist.CLIENT, bus = Mod.EventBusSubscriber.Bus.MOD)
public class ImmersiveGatewaysClientForge {
    @SubscribeEvent
    ...
    public static void registerBlockEntityRenderers(EntityRenderersEvent.RegisterRenderers event) {
        event.registerBlockEntityRenderer(BlockEntityTypes.GATEWAY.get(), GatewayBlockEntityRenderer::new);
    }
}
